 ...
 * @author saaen
 */
public class tabla_c extends javax.swing.JFrame {

    /**
     * Creates new form tabla_c
     */
    
    caracteristicas Parent;
    
    public tabla_c(caracteristicas parent) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tabla_c.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
